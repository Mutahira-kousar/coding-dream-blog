...
<blockquote class="blockquote text-center mb-5">
  <h1 class="mb-0 text-uppercase display-4">Edit Registration Detail</h1>
...
// fetch data of current login user
...
echo "<h5 class='alert alert-info'> Your Info is Updated.</h5>";
